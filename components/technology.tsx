  ...
  return (
    <section id="technology" className="lg:px-60">
      <div className="container mx-auto px-4 pt-48">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          <TechnologyCard icon={Brain} title="Neural Networks" description="Advanced neural architectures for complex decision making" />
          <TechnologyCard icon={Cpu} title="Deep Learning" description="Sophisticated deep learning models for pattern recognition" />
          <TechnologyCard icon={Code} title="Advanced ML" description="Cutting-edge machine learning algorithms" />
          <TechnologyCard icon={Globe} title="Global Scale" description="Distributed AI processing across global networks" />
        </div>
      </div>
    </section>
  );
